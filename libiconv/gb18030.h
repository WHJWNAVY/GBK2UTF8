...
static int32_t gb18030_mbtowc(conv_t conv, ucs4_t *pwc, const uint8_t *s, size_t n) {
    int32_t ret;
...
static const uint16_t gb18030_pua2charset[31 * 3] = {
    /* Unicode range   GB18030 range */
    0xe766, 0xe76b, 0xa2ab,                                                 /*.. 0xa2b0, */
    0xe76d, 0xe76d, 0xa2e4, 0xe76e, 0xe76f, 0xa2ef,                         /*.. 0xa2f0, */
    ...
    0xe796, 0xe796, 0xa6f3, 0xe797, 0xe79f, 0xa6f6,                         /*.. 0xa6fe, */
    ...
    0xe7e2, 0xe7e2, 0xa958, 0xe7e3, 0xe7e3, 0xa95b, 0xe7e4, 0xe7e6, 0xa95d, /*.. 0xa95f, */
    0xe7f4, 0xe800, 0xa997,                                                 /*.. 0xa9a3, */
    0xe801, 0xe80f, 0xa9f0,                                                 /*.. 0xa9fe, */
    0xe810, 0xe814, 0xd7fa,                                                 /*.. 0xd7fe, */
    0xe816, 0xe818, 0xfe51,                                                 /*.. 0xfe53, */
    0xe81e, 0xe81e, 0xfe59, 0xe826, 0xe826, 0xfe61, 0xe82b, 0xe82c, 0xfe66, /*.. 0xfe67, */
    0xe831, 0xe832, 0xfe6c,                                                 /*.. 0xfe6d, */
    0xe83b, 0xe83b, 0xfe76, 0xe843, 0xe843, 0xfe7e, 0xe854, 0xe855, 0xfe90, /*.. 0xfe91, */
    0xe864, 0xe864, 0xfea0,
};

static int32_t gb18030_wctomb(conv_t conv, uint8_t *r, ucs4_t wc, size_t n) {
    int32_t ret;
    ...
    if (wc >= 0xe000 && wc <= 0xe864) {
        if (n >= 2) {
            if (wc < 0xe766) {
                /* User-defined characters range U+E000..U+E765 */
                if (wc < 0xe4c6) {
                    uint32_t i = wc - 0xe000;
                    r[1] = (i % 94) + 0xa1;
                    i = i / 94;
                    r[0] = (i < 6 ? i + 0xaa : i + 0xf2);
                    return 2;
                } else {
                    uint32_t i = wc - 0xe4c6;
                    r[0] = (i / 96) + 0xa1;
                    i = i % 96;
           ...
           gb18030_pua2charset, it does so at a k with  k1 <= k < k2. */
                while (k1 < k2) {
                    ...
                    if (wc < gb18030_pua2charset[k * 3 + 0])
                        ...
                        uint16_t c = gb18030_pua2charset[k * 3 + 2] + (wc - gb18030_pua2charset[k * 3 + 0]);
                        r[0] = (c >> 8);
                        r[1] = (c & 0xff);
                        return 2;
                    }
